...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { name: "About Us", href: "/about-us", show: true },
    { name: "Contact Us", href: "/contact-us", show: true },
          ...
          <div className="flex items-center gap-10">
            {visibleLinks.map((link) => (
              <Link
                key={link.name}
                to={link.href}
                className="relative text-[11px] font-medium uppercase tracking-[0.18em] text-gray-400 hover:text-white transition group"
              >
                {link.name}
