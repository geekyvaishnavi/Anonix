...
export default function AnswerMessage() {
  ...
  const originalMessage = "How do you manage to stay so productive every day?";

  const handleSend = () => {
    console.log("Answering message:", id, "with:", answer);
    // Add logic to save to DB here
    navigate('/dashboard');
  };
  ...
  return (
    <div className="min-h-screen w-full bg-[#050505] text-white flex flex-col">
      ...
      <main className="relative z-10 flex-grow max-w-2xl mx-auto w-full px-6 pt-24 pb-12">
        ...
        <button 
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-gray-500 hover:text-[#f59e0b] transition mb-8 group"
        >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#0f0f0f] border border-white/5 p-6 rounded-3xl">
            ...
            <p className="text-lg sm:text-xl text-gray-200 font-light italic leading-relaxed">
              "{originalMessage}"
            </p>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="flex items-start gap-3 pl-4">
              ...
              <textarea
                ...
                className="w-full bg-transparent border-none text-white text-lg resize-none 
                  focus:ring-0 placeholder:text-gray-700 min-h-[200px] py-0 font-light"
              />
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-[11px] text-gray-600 max-w-[280px]">
            ...
            <button 
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-3 bg-[#f59e0b] text-black px-8 py-4 rounded-2xl font-bold text-sm hover:brightness-110 transition disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-[#f59e0b]/10"
            >
              Post Response
              <Send size={16} />
            </button>
